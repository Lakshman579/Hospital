...
--
-- Host: localhost
-- Generation Time: May 01, 2023 at 01:18 AM
...
(12, 14, 'admin', 'admin', 'Male', 'admin1@ggg.com', '2345678901', 'ashok', 500, '2023-04-24', '12:00:00', 1, 1);
...
(12, 'admin', 'admin', 'Male', 'admin1@ggg.com', '2345678901', 'admin22', 'admin22'),
(13, 'Customer', 'One', 'Male', 'customerone@gmail.com', '1274657384', '12345678', '12345678');
...
('ashok', 12, 14, 'admin', 'admin', '2023-04-24', '12:00:00', 'test', 'test', 'test');
...
--
ALTER TABLE `payments`
  ADD CONSTRAINT `payments_ibfk_1` FOREIGN KEY (`ID`) REFERENCES `appointmenttb` (`ID`);
COMMIT;
